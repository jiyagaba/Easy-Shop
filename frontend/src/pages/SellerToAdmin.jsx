                ...
                <div className='flex relative h-[calc(100vh-160px)]'>
                    ...
                    <div className={`w-[280px] absolute z-10 ${show ? 'left-0' : '-left-[300px]'} md:relative transition-all`}>
                        <div className='bg-[#2d2d48] rounded-md h-full overflow-y-auto shadow-md'>
                            ...
                            <div className='flex items-center gap-3 text-white px-4 py-3 border-b border-slate-700 hover:bg-[#3a3a57] cursor-pointer'>
                                <div className='relative'>
                                    <img src="http://localhost:3000/images/admin.jpg" alt="" className='w-10 h-10 rounded-full border-2 border-purple-400' />
                    ...
                    <div className='w-full md:ml-4'>
                        ...
                        <div className='flex justify-between items-center mb-4'>
                            <div className='flex items-center gap-3'>
                                <div className='relative'>
                                    <img src="http://localhost:3000/images/demo.jpg" alt="" className='w-11 h-11 rounded-full border-2 border-green-400' />
                                    <span className='w-3 h-3 bg-green-500 rounded-full absolute right-0 bottom-0 border-2 border-[#1e1e2f]'></span>
                                </div>
                                <h2 className='text-white font-semibold text-base'>Support</h2>
                            </div>
