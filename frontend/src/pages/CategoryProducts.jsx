...
const CategoryProducts = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        let url = `http://localhost:3000/api/categories/${category}/products`;
        const params = [];
        if (sortOrder) {
        ...
        <div className="mt-4 mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {/* Example categories, replace with dynamic categories if available */}
              {["mobiles", "laptops", "speakers", "top wear", "footwear"].map((cat) => (
