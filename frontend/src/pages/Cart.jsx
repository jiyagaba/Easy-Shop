...
const Cart = () => {
  ...
  try {
    ...
    const options = {
      key: process.env.REACT_APP_RAZORPAY_KEY || "rzp_test_1234567890abcdef", // use env variable or fallback
      ...
      handler: async function (response) {
        // Step 3: Call your payment-success API
    ...
    razor.open();
      ...
      alert("Something went wrong while processing the payment. Please try again.");
    }
  };
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="w-[85%] mx-auto py-12 flex gap-8">
        ...
        <div className="w-1/3 bg-white p-6 rounded-lg shadow-lg h-fit">
          ...
          />
          <button 
  className="w-full mt-4 px-6 py-3 rounded-full bg-purple-500 text-white font-semibold hover:opacity-90"
