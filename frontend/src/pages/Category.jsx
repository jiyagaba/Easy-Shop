...
const Category = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Debugging: Log the state before submitting
  ...
  return (
    <div className="px-2 lg:px-6 pt-6">
      <div className="flex lg:hidden justify-between items-center mb-5 bg-[#1e1e2f] border border-purple-500 rounded-lg px-4 py-3 shadow-[0_0_15px_#a855f7]">
        ...
        <button onClick={() => setShow(true)} className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md transition">
          Add
        </button>
      </div>
        ...
        <div className="w-full lg:w-7/12">
          <div className="w-full p-6 bg-[#1e1e2f] rounded-xl border border-purple-500 shadow-[0_0_15px_#a855f7]">
            ...
            <div className="w-full flex justify-end mt-4">
              <Pagination pageNumber={currentPage} setPageNumber={setCurrentPage} totalItem={filteredCategories.length} parPage={parPage} showItem={3} />
            </div>
          </div>
        </div>
